...
const FooterSection: React.FC = () => {
  return (
    <footer className="bg-dark py-10 px-6 lg:px-8 border-t border-dark-accent/30">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400">
              Transforme sua presença online em uma fonte de renda sustentável.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#preview" className="text-gray-400 hover:text-white transition-colors">Preview</a></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Reembolso</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <Button variant="ghost" size="icon" className="text-gray-400 hover:text-white hover:bg-dark-accent">
        ...
        <div className="mt-10 pt-6 border-t border-dark-accent/30 text-gray-500 text-sm">
          <p>© 2025 Monetiza. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
